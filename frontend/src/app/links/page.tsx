...
const modes = [
  ...
  ["Push · claimant-safe", "A payer funds a claim link. Fragment material stays local and is never sent to a server or persisted.", "User wallet action"],
...
export default function LinksPage() {
  return <main className="page-shell"><div className="ledger-bg" /><div className="page-content">
    <PageIntro eyebrow="PUSH + PULL MODE ENGINE" title="Simple links. Exact terms." description="Create a fresh Pull payment request or fund a Push claim link with your connected wallet. Glyph waits for real receipts and never turns escrow into fake settlement." authority="User wallet + proof-backed terminal lifecycle" />
    <JudgeConsole />
